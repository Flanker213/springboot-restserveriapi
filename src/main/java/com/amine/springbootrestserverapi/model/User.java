package com.amine.springbootrestserverapi.model;
...
import com.amine.springbootrestserverapi.dto.UserDTO;
//import com.amine.restclient.dto.UserRegistrationForm;
...
public class User implements Serializable{
	...
	public User(String login, String password, Integer active) {
		...
		return "User [id=" + id + ", login=" + login + ", password=XXXXXXX, active=" +
		active + ", roles=" + roles + "]";
		}
